...
talents = {
    ...
    "animals": [
        ...
        "They can coax even the most stubborn farm animals into doing what’s needed, making them invaluable during harvest time.",
...
def get_talent():
    for i in range(len(sys.argv)):
        if len(sys.argv) >= 1 and sys.argv[i] not in talent_list:
            talent = random_talent()
        elif len(sys.argv) >= 2 and sys.argv[i] in talent_list:
...
def specific_talent():
    for i in range(len(sys.argv)):
        if sys.argv[i] in talent_list:
            t = sys.argv[i].lower()

            if t == "instruments":
                talent = random.choice(list(talents["instruments"]))

            elif t == "languages":
                talent = random.choice(list(talents["languages"]))

            elif t == "luck":
                talent = random.choice(list(talents["luck"]))

            elif t == "memory":
                talent = random.choice(list(talents["memory"]))

            elif t == "animals":
                talent = random.choice(list(talents["animals"]))

            elif t == "children":
                talent = random.choice(list(talents["children"]))

            elif t == "puzzles":
                talent = random.choice(list(talents["puzzles"]))

            elif t == "game":
                talent = random.choice(list(talents["game"]))

            elif t == "impersonations":
                talent = random.choice(list(talents["impersonations"]))

            elif t == "drawing":
                talent = random.choice(list(talents["drawing"]))

            elif t == "painting":
                talent = random.choice(list(talents["painting"]))

            elif t == "singing":
                talent = random.choice(list(talents["singing"]))

            elif t == "drinking":
                talent = random.choice(list(talents["drinking"]))

            elif t == "carpentry":
                talent = random.choice(list(talents["carpentry"]))

            elif t == "cooking":
                talent = random.choice(list(talents["cooking"]))

            elif t == "darts":
                talent = random.choice(list(talents["darts"]))

            elif t == "dancing":
                talent = random.choice(list(talents["dancing"]))
