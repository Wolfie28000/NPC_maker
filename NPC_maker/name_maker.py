...
'''
Name and Race Extraction
'''
def extract_race_and_name(string):
    pop_words_list = ["Before", "you", "is", "a", "named"]
    updated_name_list = []
    ...
    for word in range(len(names)):
        if names[word] in pop_words_list:
            continue
        else:
            updated_name_list.append(names[word])

    if len(updated_name_list) == 4:
        race_and_name = (f"{updated_name_list[0]} {updated_name_list[1]}, {updated_name_list[2]} {updated_name_list[3]}")
    elif len(updated_name_list) == 3:
        race_and_name = (f"{updated_name_list[0]}, {updated_name_list[1]} {updated_name_list[2]}")
    else:
        race_and_name = (f"{updated_name_list[0]}, {updated_name_list[1]}")

    return race_and_name
